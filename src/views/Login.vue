<template>
  <div class="login-container">
    <div class="operations">
      <icon-button @click="()=>openUrl('https://space.bilibili.com/135427028/channel/series')" icon="icon-bilibili"/>
    ...
    <div class="login-bg">
      ...
      <div class="login-content">
        <div v-if="!isVerifySuccess" class="login-box">
          <div class="title">
            <div class="text-[28px] text-[rgb(var(--text-color))] font-[600] leading-[28px] mb-[10px]">
              Linyu在线聊天群
            </div>
          ...
          <div
              ...
              :class="['login-button', { logging: logging }]"
          >
            {{ !logging ? '验 证' : '登 录 中' }}
          </div>
        </div>
